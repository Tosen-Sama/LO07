...
<body>
  ...
  panel("Problématique :", "<strong>Tout comme pour l'<a href='./router.php?action=innovation1'>innovation 1</a> que nous avons implémentée, nous avons fait le constat que l'application ne permet pas de corriger ou de modifier les informations d'un centre de vaccination en cas "
